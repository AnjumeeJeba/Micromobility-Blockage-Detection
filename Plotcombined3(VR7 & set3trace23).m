...
(*data=Import["updated_vr_7.txt","Table"];*)
...
(* ::Input:: *)
(*ListLinePlot[{movingAvg1[[20000;;70000]],movingAvg3[[20000;;70000]]+20},PlotRange->{{20000,50000},All},PlotStyle->{BlueGray},PlotLegends->Placed[{"Micro for 0.001","Block for 0.001"},{0.8,0.7}]]*)


(* ::Input:: *)
(*ListLinePlot[{movingAvg2[[20000;;70000]]-13,movingAvg4[[20000;;70000]]},PlotRange->{{20000,50000},All},PlotStyle->{BlueGray},PlotLegends->Placed[{"Micro for 0.0001","Block for 0.0001"},{0.4,0.6}]]*)
...
(* ::Input:: *)
(*ListLinePlot[{sumPeriodograms5,sumPeriodograms4-114100},PlotRange->{{0,165},All},PlotStyle->{BlueGray},PlotLabel->"Summed Periodograms for 0.0001 micromobility & blockage",PlotLegends->Placed[{"Micro in 0.0001","Block in 0.0001"},{0.3,0.6}]]*)
